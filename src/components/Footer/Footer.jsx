...
const socialLinks = [
    ...
    {
        path: "https://www.github.com/muhammadalamzeb",
...
const Footer = () => {
  ...
  //margin: '0 auto', // Center the image horizontally
                        ...
                        <p className="text-[16px] leading-7 font-[400] text-textColor mt-4">Copyright © {year} developed by i-Clinic team all rights reserved.</p>
