...
const DoctorDetails = () => {
    ...
    const {name, qualifications, experiences, timeSlots, reviews, bio, about, averageRating, totalRating, specialization, ticketPrice, photo,phone } = doctor;
    ...
    useEffect(() => {
        if(reviews) {
            ...
            let rating = ratingSum / reviews?.length;
                ...
                <div className="grid md:grid-cols-3 gap-[50px]">
                    <div className="md:col-span-2">
                        <div className="flex items-center gap-5">
                            ...
                            <div>
                                <span className="bg-[#CCF0F3] text-irisBlueColor py-1 px-6 lg:py-3 lg:px-6 text-[12px] leading-4 lg:text-[16px] lg:leading-7 font-semibold rounded">{specialization}</span>
