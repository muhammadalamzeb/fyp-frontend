                        ...
                        <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
                            ...
                            <div>
                                <div className="lg:w-[570px]">
                                    ...
                                    md:text-[60px] md:leading-[70px]">Discover a New Era in Patient Care with i-Clinic
                                    </h1>

                                    <p className="text__para">
                                    Experience healthcare like never before with i-Clinic. 
                                    Our platform seamlessly connects you with skilled 
                                    medical professionals, ensuring a user-friendly and intuitive journey 
                                    to optimal health. 
                    ...
                    <div className="container">
                        <div className="lg:w-[470px] mx-auto">
                            ...
                            <p className="text__para text-center">
                                World-class care for everyone. Our health System offers unmatched, exprt health
                                care.
                            </p>
                        </div>
                            ...
                            <div className="py-[30px] px-5">
                                ...
                                <div className="mt-[30px]">
                                    ...
                                    <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                                        World-class care for everyone. Our health System offers unmatched, expert health care lab to clinic.
                                    </p>
                            ...
                            <div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
                                ...
                                <div className="w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]">
                                    ...
                                    <div className="flex items-center gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px]">
                                        ...
                                        <h4 className="text-[10px] leading-3 lg:text-[16px] lg:leading-[22px] font-[700] text-headingColor">Alamzeb</h4>
                                    </div>
